					...
					if ( qty ) {
						...
						if ( formatted_sub_total && '1' == $totals.data( 'show-sub-total' ) ) {
							...
							if ( ! woocommerce_addons_params.price_display_suffix || ! woocommerce_addons_params.tax_enabled ) {
								html = html + '<li class="test-class wc-pao-subtotal-line"><p class="price">' + sub_total_string + ' <span class="amount">' + formatted_sub_total + '</span></p></li></ul></div>';
								$totals.html( html );
							...
							if ( false === ( woocommerce_addons_params.price_display_suffix.indexOf( '{price_including_tax}' ) > -1 ) && false === ( woocommerce_addons_params.price_display_suffix.indexOf( '{price_excluding_tax}' ) > -1 ) ) {
								html = html + '<li class="test-class wc-pao-subtotal-line"><strong>' + sub_total_string + ' <span class="amount">' + formatted_sub_total + '</span> ' + woocommerce_addons_params.price_display_suffix + '</strong></li></ul></div>';
								$totals.html( html );
								$cart.trigger( 'updated_addons' );
								return;
							}
							...
							$.ajax( {
								...
								success: function( result ) {
									if ( result.result == 'SUCCESS' ) {
										...
										html                 = html + '<li class="test-class wc-pao-subtotal-line"><p class="price">' + sub_total_string + ' <span class="amount">' + formatted_sub_total + '</span> ' + price_display_suffix + ' </p></li></ul></div>';
										$totals.html( html );
										$cart.trigger( 'updated_addons' );
									} else {
										html = html + '<li class="test-class wc-pao-subtotal-line"><p class="price">' + sub_total_string + ' <span class="amount">' + formatted_sub_total + '</span></p></li></ul></div>';
