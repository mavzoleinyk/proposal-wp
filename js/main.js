...
jQuery(function($) {
    $('.testmonails').slick({
      ...
      <path d="M0.857864 0.857864L15 15L0.857863 29.1421" stroke="#0066C9"/>
      </svg>
 ...
 // section-box-blogs-slider (Brooklin Breadge)
    ...
    $('.bridge__articles').slick({
      arrows: false,
      vertical: true,
      slidesToShow: 4,
      asNavFor: '.bridge__img',
      infinite: false,
      responsive: [
        {
          breakpoint: 768,
    ...
    $('.bridge__article').mouseover(function() {
      let index = $(this).attr('data-slick-index');
      $('.bridge__img').slick('slickGoTo', index);
    });

    $('.video__slider').slick({
      infinite: false,
      asNavFor: '.video__dots',
    });
